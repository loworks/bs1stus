export const isMobile = () => {
  ...
  var a = global.navigator.userAgent || global.navigator.vendor;
  return (
...
export const getIsUriName = function (name: string) {
  let value = null;
  if (typeof window !== `undefined`) {
...
const fullBasename = (path: string) => {
  let result: any = "";
  if (path) {
...
export const getFileName = (urlStr?: string) => {
  let url = urlStr
    ? urlStr
