...
export default function IndexShopTitle({
  className,
  ...props
}: {
  className?: string;
  ...
  return (
    <>
      <div className="max-md:h-[100px] relative left-[-10vw] z-0 mx-auto grid w-[120%] items-center overflow-x-hidden">
        <div className="max-md:h-[100px] max-md:pt-[13px] relative overflow-hidden">
          <AnimatedTextAlongPath
            className="[&_.path]:max-md:stroke-[46px] relative z-10 [&_.path]:md:stroke-[25px]"
            ...
            strokeColor="#7a4d3c"
          >
            <div className="font-ob-nar-b max-md:text-[6.5vw] font-bold uppercase leading-[100%] text-[#fffabe] md:text-[4.5vw]">
          ...
          <svg
            ...
            className="absolute top-[4vw] z-0 fill-crisps-color2"
          >
